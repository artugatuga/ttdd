...
CREATE TABLE `playermatch` (
  ...
  `player_match_match_id` int NOT NULL,
  PRIMARY KEY (`player_match_id`),
  KEY `playerMatch_fk_player` (`player_match_player_id`),
  KEY `playerMatch_fk_matche` (`player_match_match_id`),
  CONSTRAINT `playerMatch_fk_matche` FOREIGN KEY (`player_match_match_id`) REFERENCES `matche` (`matche_id`),
  CONSTRAINT `playerMatch_fk_player` FOREIGN KEY (`player_match_player_id`) REFERENCES `player` (`player_id`)
